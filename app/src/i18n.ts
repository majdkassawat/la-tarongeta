...
const ca = {
  ...
  bizumStep1: "Envia un Bizum per 60 euros a la Sarah (672 034 539)",
  ...
  errWhatsappInvalid: "El número no sembla vàlid (ex: 612 345 678).",
...
const en: typeof ca = {
  ...
  bizumStep1: "Send a Bizum of 60 euros to Sarah (672 034 539)",
  ...
  errWhatsappInvalid: "That number doesn't look valid (e.g. 612 345 678).",
